  ...
  return (
    <div className=" ml-10">
      ...
      <div className="flex gap-4 mt-6">
        ...
        <button onClick={()=>showDialog()} className="bg-opacity-50 flex items-center bg-gray-500 px-3 text-white py-3 rounded-lg font-display hover:bg-opacity-20 font-semibold">
